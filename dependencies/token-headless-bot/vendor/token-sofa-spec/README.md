...
The SOFA (simple open financial app) protocol lets you quickly develop financial applications for clients such as [Token](https://www.tokenbrowser.com/). It is a JSON protocol that provides standard message and attachment structures,
simple UI controls, and commands to interact with the Ethereum network.
...
See also: [Creating a Token App](http://developers.tokenbrowser.com/docs/creating-a-token-app)
